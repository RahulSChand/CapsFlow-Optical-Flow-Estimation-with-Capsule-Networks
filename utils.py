...
def create_image():
    ...
    print(a[0][599][599],a[1][599][599])
    print(a[0][599][0],a[1][599][0])
    print(a[0][0][599],a[1][0][599])
    ...
    print("saving image")
    cv2.imwrite("color_wheel/is_this_the_color_4.jpeg",img)
